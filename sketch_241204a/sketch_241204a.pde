...
int index2 = 0;
PFont orcFont;
String soundFilePath = "D:\\processing-radar-code-with-extra-functionality-main\\OBJDETSOUND.wav";
String humsoundFilePath = "D:\\processing-radar-code-with-extra-functionality-main\\3.mp3";
AudioPlayer player;
